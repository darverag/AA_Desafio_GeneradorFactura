    ...
    <div class="container mt-5 pt-5">
        <div class="row g-3">
            <div class="col-md-4 ">
                ...
                <input type="text" name="nombre" class="form-control" placeholder="Ingrese nombre completo de cliente">
            </div>
            <div class="col-md-4 ">
                <label class="form-label ">Empresa</label>
                <input type="text" name="empresa" class="form-control" placeholder="Ingrese nombre de empresa">
            </div>
            <div class="col-md-4 ">
                <label class="form-label ">Rut</label>
                <input type="text" name="rut" class="form-control" placeholder="Ingrese número de RUT de cliente">
            </div>
            <div class="col-md-4 ">
                <label class="form-label ">Dirección</label>
                <input type="text" name="direccion" class="form-control" placeholder="Ingrese dirección de cliente">
            </div>
            <div class="col-md-4 ">
                <label class="form-label ">Ciudad</label>
                <input type="text" name="ciudad" class="form-control" placeholder="Ingrese ciudad de cliente">
            </div>
            <div class="col-md-4 ">
                <label class="form-label ">País</label>
                <input type="text" name="pais" class="form-control" placeholder="Ingrese país de cliente">
            </div>
        </div>
	</div>
            ...
            <tbody>
                  <c:forEach var= "producto" items="${listaProductos}">
                     <tr>
                        ...
                        <td class="text-start">$ <fmt:formatNumber value="${producto.valorUnitario}" pattern="#,##0" /></td>
                        <td><input type="number" class="form-control text-start" id="${producto.item}" name="${producto.item}" placeholder="Ingrese cantidad" min="0" max="100" value="0"></td>
                     </tr>
